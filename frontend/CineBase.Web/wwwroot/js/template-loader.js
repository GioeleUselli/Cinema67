...
async function loadLayoutComponents() {
   ...
   var pathname = (window.location.pathname || '').toLowerCase();
    var landingPaths = ['/', '/index.html', '/programmazione.html', '/scheda-film.html', '/my-cinemas.html', '/scegli-cinema.html', '/login.html', '/registrazione.html', '/profilo.html', '/membership.html', '/feste.html', '/acquista.html', '/pagamento.html', '/esito-acquisto.html', '/forgot-password.html', '/reset-password.html', '/conferma-cancellazione.html', '/conferma-export.html', '/giftcard.html', '/riscatta-giftcard.html', '/privacy.html', '/cookie.html', '/termini-condizioni.html', '/shop.html', '/articolo.html', '/pagamento-merch.html', '/esito-acquisto-merch.html', '/tracking-merch.html', '/label-pacco.html', '/completa-merch-premio.html', '/chi-siamo.html'];
