(() => {
        ...
        <aside id="admin-sidebar" class="admin-sidebar w-64 flex-shrink-0 flex flex-col fixed md:relative inset-y-0 left-0 z-50 -translate-x-full md:translate-x-0 transition-transform duration-300 border-r border-brand-outline-variant/20" style="overflow-y:auto;overflow-x:hidden">
          <div class="p-6">
            <a href="/index.html" class="flex flex-col items-center gap-2">
              <img src="/assets/logo.png" alt="Cinema67" class="h-14 w-14 rounded-full object-cover border-2 border-brand-gold/40">
              <span class="font-serif text-sm font-bold uppercase tracking-[0.18em] sidebar-text">Cinema67</span>
            </a>
          </div>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    var themeObserver = new MutationObserver(function() { applySidebarTheme(); });
