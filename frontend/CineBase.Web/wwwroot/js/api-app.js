...
deleteFilm: (id) => apiFetch(`/films/${id}`, { method: 'DELETE' }),
  ...
  getGiftCardCart: function () { return apiFetch('/giftcard/cart'); },
  saveGiftCardCart: function (items) { return apiFetch('/giftcard/cart', { method: 'PUT', body: JSON.stringify(items) }); },
  clearGiftCardCart: function () { return apiFetch('/giftcard/cart', { method: 'DELETE' }); },
  ...
  riscattaPremio: function (premioId, data) { return apiFetch('/membership/premi/' + premioId + '/riscatta', { method: 'POST', body: data ? JSON.stringify(data) : undefined }); },
  completaMerchPremio: function (data) { return apiFetch('/membership/premi/completa-merch', { method: 'POST', body: JSON.stringify(data) }); },
  ...
  createMerchPayPalOrder: function (id) { return apiFetch('/merch/orders/' + id + '/paypal-create', { method: 'POST' }); },
  captureMerchPayPalOrder: function (id) { return apiFetch('/merch/orders/' + id + '/paypal-capture', { method: 'POST' }); },
  createPayPalOrder: function (id) { return apiFetch('/checkout/orders/' + id + '/paypal-create', { method: 'POST' }); },
  capturePayPalOrder: function (id) { return apiFetch('/checkout/orders/' + id + '/paypal-capture', { method: 'POST' }); },
  paypalMembershipCheckout: function () { return apiFetch('/membership/paypal-checkout', { method: 'POST' }); },
  paypalMembershipConfirm: function () { return apiFetch('/membership/paypal-confirm', { method: 'POST' }); },
