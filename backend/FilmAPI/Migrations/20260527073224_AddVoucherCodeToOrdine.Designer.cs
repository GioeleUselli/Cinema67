...
namespace FilmAPI.Migrations
{
    ...
    [Migration("20260527073224_AddVoucherCodeToOrdine")]
    partial class AddVoucherCodeToOrdine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmAPI.Model.MerchDiscountCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ScadeIl")
                        .HasColumnType("datetime(6)");

                    b.Property<int>("Utilizzi")
                        .HasColumnType("int");

                    b.Property<decimal>("ValoreScontoFisso")
                        .HasColumnType("decimal(10,2)");

                    b.HasKey("Id");

                    b.ToTable("MerchDiscountCodes");
                });
            ...
            modelBuilder.Entity("FilmAPI.Model.MerchItemImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MerchItemImages");
                });

            modelBuilder.Entity("FilmAPI.Model.MerchItemVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmAPI.Model.MerchOrder", b =>
                {
                    ...
                    b.Property<string>("TipoConsegna")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
            ...
            modelBuilder.Entity("FilmAPI.Model.Pacco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CodicePacco")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");

                    b.Property<DateTime?>("ConsegnatoIl")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("NoteCorriere")
                        .HasMaxLength(300)
                        .HasColumnType("varchar(300)");

                    b.Property<int?>("PreparatoreId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("PresoInCaricoIl")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime?>("TentataConsegnaIl")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("FilmAPI.Model.PremioRiscatto", b =>
                {
                    ...
                    b.Property<string>("CodiceVoucher")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("FilmAPI.Model.Recensione", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ApprovataDaUserId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("ApprovataIl")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("ApprovataDaUserId");

                    b.HasIndex("Stato");

                    b.HasIndex("UserId");

                    b.HasIndex("FilmId", "Stato");
            ...
            modelBuilder.Entity("FilmAPI.Model.UserCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmAPI.Model.MerchOrder", b =>
                {
                    b.HasOne("FilmAPI.Model.Cinema", "CinemaRitiro")
                        .WithMany()
                        .HasForeignKey("CinemaRitiroId");
            ...
            modelBuilder.Entity("FilmAPI.Model.Pacco", b =>
                {
                    b.HasOne("FilmAPI.Model.User", "Corriere")
                        .WithMany()
                    ...
                    b.HasOne("FilmAPI.Model.User", "Preparatore")
                        .WithMany()
                        .HasForeignKey("PreparatoreId");

                    b.Navigation("Corriere");

                    b.Navigation("MerchOrder");

                    b.Navigation("Preparatore");
                });
            ...
            modelBuilder.Entity("FilmAPI.Model.Recensione", b =>
                {
                    b.HasOne("FilmAPI.Model.User", "ApprovataDa")
                        .WithMany()
                        .HasForeignKey("ApprovataDaUserId")
                        .OnDelete(DeleteBehavior.SetNull);
