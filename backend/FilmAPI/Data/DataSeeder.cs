...
public class DataSeeder
{
    ...
    {
        if (_context.MerchDiscountCodes.Any())
            return;

        _context.MerchDiscountCodes.AddRange(
            new MerchDiscountCode { Codice = "CINEMA20", PercentualeSconto = 20, Attivo = true, MaxUtilizzi = 500, CreatedAtUtc = DateTime.UtcNow },
            new MerchDiscountCode { Codice = "SHOP10", PercentualeSconto = 10, Attivo = true, MaxUtilizzi = 500, CreatedAtUtc = DateTime.UtcNow },
            new MerchDiscountCode { Codice = "WELCOME50", PercentualeSconto = 50, Attivo = true, MaxUtilizzi = 100, CreatedAtUtc = DateTime.UtcNow }
        );
        await _context.SaveChangesAsync();
    }
